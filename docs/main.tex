...
Indicator combinations and prediction horizons were selected to balance signal reliability and trading feasibility. We consider the prediction horizons $h \in \{2,3,\dots,10\}$ trading days rather than the next-day prediction ($h=1$). One-day horizons are dominated by market microstructure noise and transaction costs, and sentiment effects typically require multiple trading days to be reflected in the prices as market participants process new information. Horizons shorter than two days produced unstable Sharpe ratios and high-variance returns in preliminary experiments, whereas horizons longer than ten days increasingly diluted the influence of both sentiment and technical indicators and approached medium-term trend forecasting. Restricting the horizon to 2 to 10 days therefore focuses the task on short-term directional movements where behavioral and sentiment-driven inefficiencies are most pronounced, while allowing a realistic non-overlapping trading strategy with sufficient sample size for evaluation.
